...
// 	if value == nil {
// 		v.storeIdentifier(identifier, vm.FloNil{})
// 	} else {
// 		v.storeIdentifier(identifier, value.(vm.FloObject))
// 	}
...
// 	// v.Object.Compile_Pop_Jump_Back(block_end - start)
// 	return nil
...
// 	// var args FloList
// 	// if params != nil {
// 	// 	FloList(params.(FloList))
// 	// }
// 	params := v.Visit(ctx.Parameters())
// 	if params == nil {
// 		v.Object.Compile_Build_List(uint32(0))
// 	}

// 	v.Object.Compile_Make_Function(vm.FloString(name.GetText()))
// 	v.Visit(ctx.Block())
...
// 	v.Object.Compile_Build_List(uint32(len(vals)))
